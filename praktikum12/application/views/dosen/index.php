							...
							<tbody>
								...
								foreach ($list_dsn as $dsn) : ?>
									<tr>
										...
										<td width="200px">
											<a href="view?id=<?php echo $dsn->nidn ?>">View</a> |
											<a href="edit?id=<?php echo $dsn->nidn ?>">Update</a> |
											<a href="delete?id=<?php echo $dsn->nidn ?>" onclick="return confirm('Apakah Anda Yakin');">Hapus</a>
										</td>
									</tr>
								<?php endforeach; ?>
							</tbody>
